<div align="center">
  ...
  <p>193 fast, free, browser-based utilities. No uploads, no accounts, no tracking, no backend.</p>
...
| Converters    | Markdown/HTML, CSV/JSON/XML/YAML/TSV, Markdown table generator, CSV splitter, subtitle converter and timing shifter, data size converter, unit converter, Morse code translator, Roman numeral converter, Base32 encoder and decoder, HTML table to CSV/JSON/Markdown, number to words, and other format converters                                                                                                                                                                                                                                                                                                                 |
...
| Utilities     | Percentage, GST, loan EMI, compound interest, aspect ratio, print size and DPI, and descriptive statistics calculators; browser info, clipboard inspector, user agent parser, keyboard tester, gamepad tester                                                                                                                                                                                                                                                                                                                                                                                                                       |

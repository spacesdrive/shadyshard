<div align="center">
  ...
  <p>208 fast, free, browser-based utilities. No uploads, no accounts, no tracking, no backend.</p>
...
| Category      | Examples                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Developer     | JSON formatter, validator, minifier, diff, JSON to TypeScript; Base64, URL, HEX, and binary encode/decode; UUID and Nano ID generators; SHA-256; JWT decoder; URL parser; cron expression parser; IP subnet calculator; HAR file analyzer; regex tester; chmod calculator; SQL formatter; JSONL/NDJSON converter; XML formatter; cURL to fetch converter; JSON Schema generator; gzip size calculator; env file converter; CSS minifier and formatter; JSON to Go struct; CSV to SQL insert; JSON to Python model; HTML to JSX; SVG to React component; Cache-Control header builder; OpenAPI to Markdown; JSON flattener; CSV diff; XPath tester; CSS selector tester; JSON Patch generator; IEEE 754 floating point converter; bitwise calculator |
| Text          | Word/character counters, word frequency counter, case converter, slug generator, line sorter, duplicate-line remover, text diff checker, invisible character remover, Markdown preview and TOC generator, HTML escape, readability score checker, list delimiter converter, Unicode character inspector, bionic reading converter, text to speech reader, list comparer, text chunker, bulk find and replace, line break remover, tabs to spaces converter, line prefix and suffix adder                                                                                                                                                                                                                                                            |
| Image         | Compressor, resizer, cropper, format converters (PNG, JPG, WebP, SVG to PNG), SVG optimizer, EXIF remover and metadata viewer, favicon generator, signature pad, image to Base64, watermark, placeholder image generator, image splitter, image combiner, LQIP placeholder generator, image redactor                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| PDF           | Merge, split, extract/rotate/reorder/delete pages, compress, metadata view/remove, text extraction, PDF-to-images, images-to-PDF, password checker, watermark, page numbering, N-up layout, margin cropper                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Converters    | Markdown/HTML, CSV/JSON/XML/YAML/TSV, Markdown table generator, CSV splitter, subtitle converter and timing shifter, data size converter, unit converter, Morse code translator, Roman numeral converter, Base32 encoder and decoder, HTML table to CSV/JSON/Markdown, number to words, TOML to JSON, fixed width to CSV, and other format converters                                                                                                                                                                                                                                                                                                                                                                                               |
| Color and CSS | Color converter, gradient generator, contrast checker, color blindness simulator, image palette extractor, color shade generator, box-shadow/text-shadow/border-radius/grid/flexbox generators, clamp generator, unit converter, cubic-bezier editor, keyframe animation generator, specificity calculator                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| SEO           | Meta tag generator, robots.txt generator and tester, sitemap generator, Open Graph preview, UTM link builder, hreflang tag generator, SERP snippet preview, schema markup generator, Open Graph image generator, redirect map generator, keyword grouper, llms.txt generator, HTML link extractor                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| QR            | QR code generator, WiFi QR code generator, and camera-based scanner                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Security      | Password generator, password strength checker, text encrypter, TOTP code generator, file hashing, checksum verification, file signature/MIME inspection, email header analyzer, SPF/DMARC record checker, CSP header generator, JWT generator, HMAC generator, punycode and IDN converter, OAuth PKCE generator, hash identifier, Caesar cipher and ROT13, text redactor, security.txt generator, URL tracking parameter remover, duplicate file finder, SRI hash generator                                                                                                                                                                                                                                                                         |
| Generators    | QR codes, passwords, UUIDs, Nano IDs, favicons, ICS calendar events, vCard contact cards, ULIDs, mock data for JSON/CSV/SQL, barcodes (Code 128, EAN-13, UPC-A)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Time and date | Unix timestamp converter, time zone converter, age, date-difference, reading-time, duration, and business-days calculators                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Utilities     | Percentage, GST, loan EMI, compound interest, aspect ratio, print size and DPI, and descriptive statistics calculators; browser info, clipboard inspector, user agent parser, keyboard tester, gamepad tester, microphone tester, webcam tester                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |

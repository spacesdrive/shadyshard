<div align="center">
  ...
  <p>163 fast, free, browser-based utilities. No uploads, no accounts, no tracking, no backend.</p>
...
| Converters    | Markdown/HTML, CSV/JSON/XML/YAML/TSV, Markdown table generator, CSV splitter, subtitle converter and timing shifter, data size converter, unit converter, Morse code translator, Roman numeral converter, and other format converters                                                                                                                                                                                                                                                       |
...
| SEO           | Meta tag generator, robots.txt generator and tester, sitemap generator, Open Graph preview, UTM link builder, hreflang tag generator, SERP snippet preview, schema markup generator, Open Graph image generator                                                                                                                                                                                                                                                                             |
...
| Utilities     | Percentage, GST, loan EMI, compound interest, and aspect ratio calculators; browser info, clipboard inspector, user agent parser                                                                                                                                                                                                                                                                                                                                                            |

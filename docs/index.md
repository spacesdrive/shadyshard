...
docs/
  ...
  ci-cd/
    ci-cd.md                       Pipeline: hooks, CI jobs, deploy gate, troubleshooting.
  workflow/
...
| [testing/testing.md](testing/testing.md)                           | The pre-completion checklist, automated test conventions (Vitest, React Testing Library, Playwright), and the Chrome DevTools MCP verification workflow.                                                                              | Before considering any task complete; writing or reviewing a test.                                                                       |
| [ci-cd/ci-cd.md](ci-cd/ci-cd.md)                                   | The full pipeline: Git hooks, CI jobs, PR validation, the Cloudflare Pages deploy gate, and troubleshooting.                                                                                                                          | Touching a workflow file, a `scripts/validate-*` script, or diagnosing a CI/deploy failure.                                              |
...
| The verification process itself, a test framework, or a test convention                                               | [`testing/testing.md`](testing/testing.md)                                                                                                                                                                                     |
| A GitHub Actions workflow, a `scripts/validate-*`/`check-*` script, Git hooks, or the Cloudflare deploy configuration | [`ci-cd/ci-cd.md`](ci-cd/ci-cd.md)                                                                                                                                                                                             |
...
| A user-facing feature or fix ships                                                                                    | [`CHANGELOG.md`](../CHANGELOG.md) (`Unreleased` section) -- see [git-workflow.md § Documentation in Commits](git/git-workflow.md#documentation-in-commits)                                                                     |
| A release is tagged                                                                                                   | [`CHANGELOG.md`](../CHANGELOG.md) (move `Unreleased` to a dated version) -- see [git-workflow.md § Release Tagging](git/git-workflow.md#release-tagging)                                                                       |
